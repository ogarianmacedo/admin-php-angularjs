angular.module('app').controller('sliderCtrl', function($scope, $http, $location, $state, SliderService) {
    ...
    // SALVA SLIDER NO BANCO DE DADOS COM TITULO E NOME DA IMAGEM > FAZ UPLOAD IMAGEM NA PASTA UPLOAD/SLIDER
    $scope.novoSlider = {};
